...
HD_PWD='C:/Github/Monitorias_ElectronicaDigital/00-TutorialesBasys3/01-Tutorial1/Tutorial1/Tutorial1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tutorial1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tutorial1.tcl
