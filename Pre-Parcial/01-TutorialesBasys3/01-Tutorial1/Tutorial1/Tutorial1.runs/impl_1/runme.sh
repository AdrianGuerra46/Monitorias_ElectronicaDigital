...
HD_PWD='C:/Github/Monitorias_ElectronicaDigital/00-TutorialesBasys3/01-Tutorial1/Tutorial1/Tutorial1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tutorial1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tutorial1.tcl -notrace
